...
(function () {
  var COUNTRIES = [
    ...
    {code:"HM",name:"Heard & McDonald Islands",dial:"+672"},
    ...
    {code:"PN",name:"Pitcairn",dial:"+870"},
    ...
    {code:"GS",name:"South Georgia & South Sandwich Islands",dial:"+500"},
    ...
    {code:"SJ",name:"Svalbard & Jan Mayen",dial:"+47"},
  ...
  var stateSelect = document.getElementById('f-state');
  if (stateSelect) {
    ...
    other.value = 'Outside the U.S.';
    other.textContent = 'Outside the U.S.';
